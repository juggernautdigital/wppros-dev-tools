...
class Wpproz_Dev_Tools {
	 ...
	 *
	 * - Wpproz_Dev_Tools_Loader. Orchestrates the hooks of the plugin.
	 * - Wpproz_Dev_Tools_i18n. Defines internationalization functionality.
	 * - Wpproz_Dev_Tools_Admin. Defines all hooks for the admin area.
	 * - Wpproz_Dev_Tools_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wpproz-dev-tools-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wpproz-dev-tools-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wpproz-dev-tools-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-wpproz-dev-tools-public.php';
	 ...
	 *
	 * Uses the Wpproz_Dev_Tools_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
